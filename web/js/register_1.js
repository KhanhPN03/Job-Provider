...
formActions.addEventListener("submit", (e) => {
    ...
    if (arrInput) {
        ...
        {
            window.location.replace(`/projob/register?username=${user.value}
&password=${pass.value}&email=${email.value}&name=${fullname.value}
&dob=${dob.value}&phone=${phone.value}&address=${address.value}
&Q1=${q1.value}&Q2=${q2.value}&ansQ1=${as1.value}&ansQ2=${as2.value}`)
        }
    }
}
);
