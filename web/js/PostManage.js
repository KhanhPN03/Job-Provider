...
function displayAllJob() {
    ...
    for (let i = tab_start; i < tab_end; i++) {
        ...
        let newJob = `<div class="content__body__post flex-row">
            ...
            src = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/FTEL_Logo.svg/470px-FTEL_Logo.svg.png"
            alt = "" >  
            </div >  
            <div class="content__body__comp  col-6 col-md-6">  
            <h5>   ${listJob[i].job_name}   </h5>  
            <p class="d-none d-sm-block class="job_manage_des">   ${listJob[i].job_des}   </p>  
            </div>  
            ...
            <a><i class="bx bxs-edit-alt"></i>Close Post</a>  
             ...
             <li>  
             <a><i class="bx bxs-edit-alt"></i>Delete Post</a>  
             </li>  
            <li>  
             <a href="ViewPostDetailController?postD_id=${listJob[i].postD_id}&post_id=${listJob[i].post_id}"><i class="bx bxs-book-open"></i>View Detail</a>  
             </li>  
             </ul>  
            </div>  
            </div>  
