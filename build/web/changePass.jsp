...
<body>
    ...
    <div class="container col-lg-4">
        <form action="ChangePassController" method="post">
            ...
            <h2 class="form-name">CHANGE PASSWORD</h2>
            ...
            <div class="form-control">
                <input id="username" name="old" type="text" placeholder=""/>
            ...
            <!--<div class="separator"><span class="separator_text" id="providers__separator_text">These questions will be used to verify your identity and recover your password if you ever forget is.</span></div>-->

            <div class="form-desciprion my-4">
                <p class="m-0">These questions will be used to verify your identity and recover your password if you ever forget is.</p>
            </div>
